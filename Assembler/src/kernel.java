...
class kernel{
    ...
    kernel(String file_name, String kernel_name,vanillaAssembler Assem) throws IOException{
        ...
        name = kernel_name;
        out_code = new BufferedWriter(new FileWriter("..\\Core\\" + kernel_name+"_i.hex"));
        out_reg  = new BufferedWriter(new FileWriter("..\\Core\\" + kernel_name+"_r.hex"));
        out_info = new BufferedWriter(new FileWriter("..\\Core\\" + kernel_name+"_info.txt"));
        Assembler = Assem;
    	initialization();
    }
    ...
    public static enum opcodes {
		ADDU, SUBU, SLLV, SRAV, SRLV, AND, OR, NOR, SLT, SLTU, MOV, LW, LBU, SW, SB, LBR, JALR,
